...
import { getAllMatchResults } from "@/lib/readallGameReults"
              ...
              <Table>
                ...
                <TableBody>
                  {sortedGames.map((game, index) => {
                    // Determine winner color based on actual player names
                    let winnerColorClass = "text-yellow-400" // default color (e.g., tie)

                    if (game.winner === game.player1Name) winnerColorClass = "text-cyan-400"
                    else if (game.winner === game.player2Name) winnerColorClass = "text-purple-400"

                    return (
                      <TableRow key={game.id ?? index} className="border-white/10 hover:bg-white/5">
